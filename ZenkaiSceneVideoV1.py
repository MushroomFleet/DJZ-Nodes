...
class ZenkaiSceneVideoV1:
    def __init__(self):
        pass
        
    @classmethod
    def INPUT_TYPES(cls):
        # Create the scene video folder path
        scenevideo_folder = os.path.join(os.path.dirname(__file__), 'scenevideo')
        
        # Make sure the folder exists
        if not os.path.exists(scenevideo_folder):
            os.makedirs(scenevideo_folder, exist_ok=True)
            folders = []
        else:
            # Get list of folders in the scenevideo directory
            folders = [f for f in os.listdir(scenevideo_folder) 
                      if os.path.isdir(os.path.join(scenevideo_folder, f))]
    ...
    def load_scene_video(self, folder: str, pattern: str = '*', index: int = 0, 
        ...
        scenevideo_folder = os.path.join(os.path.dirname(__file__), 'scenevideo')
        path = os.path.join(scenevideo_folder, folder)
...
# Register the node
NODE_CLASS_MAPPINGS = {
    "ZenkaiSceneVideoV1": ZenkaiSceneVideoV1
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ZenkaiSceneVideoV1": "Zenkai Scene Video V1"
}
