...
class LoadVideoDirectoryV2:
    ...
    def load_video_directory(self, path: str, pattern: str = '*', index: int = 0, 
                           ...
                           seed: int = 0, label: str = 'Video Batch 001', force_rate: int = 0,
...
# Register the node
NODE_CLASS_MAPPINGS = {
    "LoadVideoDirectoryV2": LoadVideoDirectoryV2
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "LoadVideoDirectoryV2": "Load Video Directory V2"
}
