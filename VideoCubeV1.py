...
class VideoCubeV1:
    def __init__(self):
        self.type = "VideoCubeV1"
        self.output_type = "IMAGE"
        self.output_dims = 3
        self.compatible_decorators = ["RepeatDecorator", "LoopDecorator"]
        self.required_extensions = []
        self.category = "Video/Animation"
        self.name = "🎲 Video Cube Generator"
        self.description = "Generates 3D rotating cube animations with customizable parameters"
    ...
    def get_color_palette(self, scheme):
        """Define color palettes for the cube faces"""
        palettes = {
            "rainbow": [
    ...
    def create_cube_vertices(self, size=1.0):
    ...
    def create_cube_faces(self):
        """Define cube faces for solid rendering"""
        return [
            [0, 1, 2, 3],  # front
            [5, 4, 7, 6],  # back
            [4, 0, 3, 7],  # left
    ...
    def render_frame(self, width, height, frame, params):
        """Render a single frame of the cube animation"""
        img = np.zeros((height, width, 3), dtype=np.uint8)
        
        # Create cube vertices
        vertices = self.create_cube_vertices(params['cube_size'])
...
NODE_CLASS_MAPPINGS = {
    "VideoCubeV1": VideoCubeV1
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "VideoCubeV1": "🎲 Video Cube Generator"
}